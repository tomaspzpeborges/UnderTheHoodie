...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_statusbarcolor/flutter_statusbarcolor.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/stripe_payment/stripe_payment.framework"
fi
